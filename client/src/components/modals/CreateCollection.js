...
const CreateCollection = observer(({ show, onHide }) => {
    ...
    const addCollection = () => {
        ...
        // createCollection({ name, description, img: file, userId, categoryId }).then((data) => {
        //     debugger;
        ...
        createCollection(formData).then((data) => {
            return onHide(), setName(""), setFile(null), setDescription("");
        });
    };

    // console.log(name, file, description, id, categoryId);
