            ...
            <div className="relative p-5 w-full max-w-xs max-h-full">
                ...
                <div className="relative bg-white rounded-3xl shadow dark:bg-gray-800">
                    ...
                    <form className="py-2 md:py-4 px-2 md:px-7 text-center">
                        ...
                        <button
                            type="submit"
                            className="w-full mx-auto block my-4 text-white  items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                            onClick={onHide}>
                            Ok
                        </button>
                    </form>
