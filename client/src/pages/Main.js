...
const Main = () => {
    ...
    const img =
        "https://i.discogs.com/eI4OnxVfgq-Vw71JUjOa7cFkOz-phqwgKjAfDSWqUU4/rs:fit/g:sm/q:90/h:600/w:594/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTgzMDcy/MjMtMTQ1OTA0MjE3/MS0yMjI4LmpwZWc.jpeg";
    return (
                    ...
                    <div className="flex flex-row gap-3 flex-nowrap w-full overflow-auto">
                        {collection.collections.map((col) => {
                            return (
                                <div
                                    key={col.id}
                                    className=" min-w-[280px] bg-white border border-gray-200 rounded-3xl shadow mt-2 md:mt-9 dark:bg-gray-800 dark:border-gray-700">
                                    <a href="#">
                                        <img
                                    ...
                                    <div className="pb-5 px-5">
                                        ...
                                        <a href="#">
                                            <h5 className="mb-3 font-bold text-gray-900 dark:text-gray-400">
                                                Category:{" "}
